...
export default function App() {
  ...
  const topCompensation = navUnlocked
    ? "calc(var(--global-stepnav-h, 0px) + 8px + env(safe-area-inset-top, 0px))"
    : "0px";
  ...
  return (
    <div
      style={{
        ...
        perspective: "none",
        // NEW:
        paddingTop: topCompensation,
        // чтобы scrollIntoView не прятался
        scrollPaddingTop: topCompensation
      }}
    >
