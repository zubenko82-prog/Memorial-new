...
// Компактный режим (<= 420px): full-bleed (без отступов слева/справа) и ВСЕГДА 2 столбца для «Люди» (если есть тыл) и «Эскизы».
// Дополнительно: уменьшенные паддинги/шрифты в компактном режиме, чтобы всё помещалось.
