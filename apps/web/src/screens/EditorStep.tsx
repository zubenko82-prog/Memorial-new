  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: MAX_W, margin: "0 auto" }}>
        ...
        >
         Сделайте набросок: кликните по миниатюре, затем настройте позицию и масштаб. Не уверены или нет конкретных пожеланий? Оставьте эскиз пустым, на усмотрение специалиста — нажмите «Продолжить».
        </section>
